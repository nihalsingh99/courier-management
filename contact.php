...
<p>Near RRCE, Banglore (560060)</p>



<p><u>support<a href="#">@rrce.</a>in</u></p>
            ...
            <div class="container">
                    <div class="top-footer-grids">
                            <div class="top-footer-grid">
                                    <h3>Contact us</h3>
                                    <ul class="address">
                                        <li><span class="map-pin"> </span><label> <br> <br>Near RRCE, Banglore (560060) </label></li>
                                        <li><span class="mob"> </span></li>
                                        <li><span class="msg"> </span><a href="#">hello@rrce.in</a></li>
                                    </ul>
                            </div>
                            <div class="top-footer-grid">
    ...
    <div class="bottom-footer">
            <div class="container">
                    <div class="bottom-footer-left">
                             ...
                             <p> &copy; 2017 rrce.in. All rights reserved</p>
                    </div>
                    <div class="clear"> </div>
            </div>
    </div>
